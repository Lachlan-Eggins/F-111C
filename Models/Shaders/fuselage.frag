...
//   re-written by Isaaac Gibbs using parts of the original as a base
//   still heavily WIP
...
void main (){
    ...
    vec4 finalfinalColor = mix(reflectionMix * 1.15 + 0.15, reflectionMix, fresnel);
    ...
    //gl_FragColor = mix(vec4(0,0,0,0),vec4(1,1,1,1),shadowmap);
